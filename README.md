...
If the times **don't match**, write an direct message to Pen (name might be not up to date at all times, ask a R4/5 for the current name) and explain why you can participate at a time you didn't vote for.
...
If you are unsure about your time, write another direct message to Pen (name might be not up to date at all times, ask a R4/5 for the current name) and ask.
